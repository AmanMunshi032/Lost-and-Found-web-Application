...
const{sigin,sigingoogle,setuser }=use(Authcontext)
const hendelsigin =(e)=>{
 e.preventDefault();
 const form = e.target;
...
const handelgoogle=()=>{
  ...
  Login with Google
            ...
            <p>New to  this site ? please<Link state={{from }} className=" text-blue-500 underline ml-2 font-bold" to ='/Register'>Regester</Link></p>
          </div>
        </div>
    </div>
    );
